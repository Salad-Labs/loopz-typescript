...
/**
 * Validates the field and value of a specific filter in the ListProposalsFilters object.
 * @param {FilterName} field - The field name to validate.
 * @param {ListProposalsFilters[FilterName]} value - The value associated with the field.
 * @throws {Error} Throws an error if the field or value is invalid.
 * @returns None
 */
export function validateListProposalsFiltersField<
  FilterName extends keyof ListProposalsFilters
>(field: FilterName, value: ListProposalsFilters[FilterName]) {
  switch (field) {
    case "owner": {
      const _value = value as ListProposalsFilters["owner"]
    ...
    case "collections": {
      const _value = value as ListProposalsFilters["collections"]
    ...
    case "status": {
      const _value = value as ListProposalsFilters["status"]

      if (_value === null || typeof _value === "undefined") return
      else if (
        (typeof _value !== "string" && typeof _value !== "number") ||
        (typeof _value === "string" &&
          !Object.keys(PROPOSAL_STATUS).includes(_value)) ||
        (typeof _value === "number" &&
          !Object.values(PROPOSAL_STATUS).includes(_value))
      )
    ...
    case "type": {
      const _value = value as ListProposalsFilters["type"]

      if (_value === null || typeof _value === "undefined") return
      else if (
        (typeof _value !== "string" && typeof _value !== "number") ||
        (typeof _value === "string" &&
          !Object.keys(PROPOSAL_TYPE).includes(_value)) ||
        (typeof _value === "number" &&
          !Object.values(PROPOSAL_TYPE).includes(_value))
      )
    ...
    case "typeOffered": {
      const _value = value as ListProposalsFilters["typeOffered"]
    ...
    case "typeWanted": {
      const _value = value as ListProposalsFilters["typeWanted"]
    ...
    case "verified": {
      const _value = value as ListProposalsFilters["verified"]
    ...
    case "network": {
      const _value = value as ListProposalsFilters["network"]
    ...
    case "offers": {
      const _value = value as ListProposalsFilters["offers"]
    ...
    case "expirationDate": {
      const _value = value as ListProposalsFilters["expirationDate"]
    ...
    case "includeParent": {
      const _value = value as ListProposalsFilters["includeParent"]
